...
def test_calculate_tax_invalid_tax(tax_rate):
    with pytest.raises(ValueError):
...
def test_calculate_tax_with_round_digits(round_digits, expected):
...
def test_calculate_tax_with_round_digits(price, tax_rate, discount, round_digits):
    with pytest.raises(TypeError):
        calculate_tax(price, tax_rate, discount=discount, round_digits=round_digits)

def test_calculate_tax_with_round_digits():
    with pytest.raises(TypeError):
